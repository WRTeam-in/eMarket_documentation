...
The partner app and the customer app use the same versions. Using a different Flutter or JDK version is the most common cause of build failures. If you are on an older eMarket release, check the [Version History](../changelog/version-history.md) for the matching versions.
...
- [Configuration](./configuration/run-the-app.md) — app name, logo, package name, theme, fonts
