...
# eMarket Flutter App Documentation

Welcome to the eMarket Flutter App documentation. This section provides detailed guides on setting up, configuring, and customizing the customer-facing mobile application.

## Getting Started

- [Flutter App Overview](./intro.mdx) - Introduction to the eMarket Flutter App
