...
Welcome to the official documentation for eMarket - the complete multi-vendor, multi-module commerce solution with Flutter apps and admin panel.
...
eMarket is designed to be scalable, customizable, and feature-rich, providing everything needed to launch and manage a multi-vendor, multi-module commerce business.

## Who is this documentation for?

This documentation is intended for:

- **Store Owners** - Learn how to set up and manage your eMarket platform
...
To get started with eMarket, visit the following sections:
...
- [Features Overview](./features/intro.mdx)
