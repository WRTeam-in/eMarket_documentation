...
const config = {
  title: "eMarket Documentation",
  tagline:
    "Multi-Vendor, Multi-Module Commerce Platform — Grocery, Pharmacy, eCommerce & More — Flutter Apps with Admin Panel",
  favicon: "img/app_icon.png",

  // Set the production url of your site here
  url: "https://wrteam-in.github.io",
  baseUrl: "/eMarket_documentation/",
  ...
  projectName: "eMarket_documentation", // Usually your repo name.
  trailingSlash: true,
  onBrokenLinks: "warn",
